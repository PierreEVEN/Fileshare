...
impl VideoTranscodeStream {
    pub fn new(source: PathBuf, media_id: u64, info: StreamInfo, stream_index: u32, container_bitrate: Option<u64>, is_default: bool) -> Self {
        Self {
            source,
            media_id,
            info,
...
impl Stream for VideoTranscodeStream {
    fn build_manifest(&self, w: &mut XmlWriter, start_num: u32) {
        let bitrate = self.info.get_bitrate()
