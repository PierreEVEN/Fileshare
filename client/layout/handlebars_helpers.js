...
Handlebars.registerHelper("ctx", function (options) {
    ...
    return new Handlebars.SafeString("console.assert(window.__handlebar_custom_loader.__registered_ctx[" + this['__handlebar_ctx_id'] + "], 'no context provided for : " + options + "'); window.__handlebar_custom_loader.__registered_ctx[" + this['__handlebar_ctx_id'] + "]." + options);
});
